...
const FormLogin = () => {
  ...
  const buttonClasses =
    "bg-gradient-to-bl from-blue-800 to-blue-950 hover:from-indigo-700 hover:to-indigo-950 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-1/2 lg:w-1/4";
  ...
  return (
    <div className="mt-16 flex justify-center items-center container mx-auto px-5">
      <Formik
      ...
      >
        {() => (
          <Form className="w-full lg:w-1/3 bg-gradient-to-br from-slate-900 to-slate-700 shadow-md rounded mx-auto mt-10 p-10 text-white bold space-y-6">
            {formSend && (
              <div className="bg-red-800 text-white font-bold text-md mt-1 mb-4 text-center">
                ¡Datos incorrectos!
              </div>
            )}
            <h2 className=" text-blue-400 font-bold text-4xl text-center mb-12">
              Inicio Sesion
            </h2>
            <div className="mb-4">
