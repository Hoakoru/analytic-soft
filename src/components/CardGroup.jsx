    ...
    <div className="relative">
      ...
      >
        <div className="flex flex-col justify-center items-center space-y-24 lg:flex-row lg:space-x-24 lg:space-y-0 lg:px-10 h-full">
          <div
            className={`relative flex items-center rounded-3xl shadow-xl border-red-500 ${extraStyles} ${
              plan === 1 ? "border-4" : "border-2"
            }`}
            onClick={() => {
              setPlan(1);
            }}
          ...
          >
            <Card image={img2} location={location}>
              {location.pathname !== "/suscription/plans" ? (
                ...
                <InformationPlan title={"Plan Plus+"} price={"70 BOB/mes"} color={"text-sky-500"}>
                  <li>Gestor de empleados</li>
          ...
          <div
            className={`relative flex items-center rounded-3xl shadow-xl border-orange-500 ${extraStyles} ${
              plan === 3 ? "border-4" : "border-2"
            }`}
            onClick={() => {
              setPlan(3);
            }}
          >
            <Card image={img3} location={location}>
              {location.pathname !== "/suscription/plans" ? (
                ...
                <InformationPlan title={"Plan Premium"} price={"150 BOB/mes"} color={"text-yellow-300"}>
                  <li>Gestor de empleados</li>
                  <li>Gestor de ventas</li>
                  <li>Consultor especialista</li>
